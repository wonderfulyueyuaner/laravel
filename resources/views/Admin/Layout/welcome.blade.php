...
<div class="page-container">
	<p class="f-20 text-success">欢迎使用 <span class="f-14">YY.admin  v1.1</span>后台模版！</p>
	<p>登录次数：18 </p>
	
	<p>上次登录IP：  上次登录时间：<?php echo date('Y-m-d H:i:s',time($_SERVER['REQUEST_TIME'])) ?></p>
...
<footer class="footer mt-20">
	<div class="container">
		<p>感谢jQuery、layer、laypage、Validform、UEditor、My97DatePicker、iconfont、Datatables、WebUploaded、icheck、highcharts、bootstrap-Switch<br>
			Copyright &copy;2015-2017 {{$title}} All Rights Reserved.<br>
			本后台系统由<a href="http://www.h-ui.net/" target="_blank" title="H-ui前端框架">YY 前端框架</a>提供前端技术支持</p>
	</div>
</footer>
